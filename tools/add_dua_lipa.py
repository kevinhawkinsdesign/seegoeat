...
PLACES_DATA = [
    ...
    ("São Paulo", "Matiz", "Nightlife", "This is where the music is good, the caipirinhas are great, and the crowd has a mix of music genres that means if you want to just listen you can or, of course, you can get up and dance.", 3.7),
    ...
    ("Prishtina", "Soma Slow Food", "Food", "The food at Soma Slow Food is what I love. Everything feels like it came from somewhere close and was made with genuine care. Simple, honest cooking.", 4.2),
